...
CREATE TABLE `app_user` (
  ...
  `method` varchar(255) DEFAULT NULL COMMENT '方法类别',
  PRIMARY KEY (`id`),
...
-- Records of app_user
-- ----------------------------
INSERT INTO `app_user` VALUES ('1', 'admin', '$2a$10$3uOoX1ps14CxuotogUoDreW8zXJOZB9XeGdrC/xDV36hhaE8Rn9HO', '测试1', '', '', '1', '1', 'APP', '2018-01-17 16:57:01', '2018-01-17 16:57:01', null, null);
INSERT INTO `app_user` VALUES ('2', 'superadmin', '$2a$10$.gLkG0j2kM0stWoOvPBvqu0H9uSD0HUlpErI.PTKyZQkSUZIV2wFq', '超级管理员', null, null, '1', '1', 'BACKEND', '2018-01-19 20:30:11', '2018-01-19 20:30:11', null, null);
INSERT INTO `app_user` VALUES ('3', '奋斗的风格', '$2a$10$xDeTAX.D8gU9ofGJFFdGKOZUtNbwNP3uKNQqAWNfJ6igMteLCZH.2', '第三方的', null, null, '1', '1', 'BACKEND', '2019-06-21 22:06:19', '2019-06-21 22:06:19', null, null);
INSERT INTO `app_user` VALUES ('4', 'dfsdg', '$2a$10$.YeYy0c4Iz9LRB87V5I85eM6boclQ8J5M.HS9St/Lg8tXTMLjmBRO', 'sdgd', null, null, '1', '1', 'BACKEND', '2019-06-22 19:20:31', '2019-06-22 19:20:31', null, null);
INSERT INTO `app_user` VALUES ('5', 'df', '$2a$10$FbRPef1YxmMgtXspNi.qjuC67xgTZ6z.v47EUlceTc.wTJxDS2Jre', 'sdfs', null, null, '1', '1', 'BACKEND', '2019-06-22 22:23:09', '2019-06-22 22:28:53', null, null);
...
INSERT INTO `sys_permission` VALUES ('35', 'client:del', '删除client', '2018-06-28 17:06:39', '2019-06-22 23:56:19');
...
INSERT INTO `sys_role` VALUES ('2', 'LS', '临时用户', '2019-06-21 22:04:22', '2019-06-23 02:05:03');
...
INSERT INTO `user_credentials` VALUES ('df', 'USERNAME', '5');
INSERT INTO `user_credentials` VALUES ('dfsdg', 'USERNAME', '4');
INSERT INTO `user_credentials` VALUES ('superadmin', 'USERNAME', '2');
INSERT INTO `user_credentials` VALUES ('奋斗的风格', 'USERNAME', '3');
